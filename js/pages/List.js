...
export default {
        ...
        <div class="meta-container">
            ...
            <div class="meta">
                ...
                <p>
                    ...
                    (however, FPS bypass is allowed with no limits)
                </p>

                <p>
                    Achieved the record on the level that is listed on the site -
                    please check the level ID before you submit a record
                </p>

                <p>
                    Have either click counter with CPS counter
                    (optional clicks sounds mod), or audio clicks on the video.
                    Edited audio only does not count
                </p>

                <p>
                    The recording must have a previous attempt and entire death
                    animation shown before the completion, unless the completion
                    is on the first attempt. Everyplay records are exempt from this
                </p>
    ...
    computed: {
         ...
         * Liste filtrée.
         *
         * On conserve l'index original du niveau afin que
         * le rang, le score et le niveau sélectionné restent corrects.
         */
        filteredList() {
